...
public class HChannelImpl implements HChannel {
    ...
    private void onChannelConnected(ChannelFuture future) {
        ...
        /* msgbus  team */        
       /* PubSubData myPubSubData = new PubSubData(ByteString.copyFromUtf8("hubs"), null, null, OperationType.START_DELIVERY, null,
                null, channel);
        PubSubRequest.Builder reqBuilder =
                NetUtils.buildPubSubRequest(channelManager.nextTxnId(), myPubSubData);            
        writePubSubRequest(myPubSubData, reqBuilder.build());*/ 
        /* msgbus  team */
    }
