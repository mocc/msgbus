...
public class FIFODeliveryManager implements Runnable, DeliveryManager,
			...
			synchronized (this) {
				...
				if (msgLimitExceeded()) {
					logger.info(
							...
							va(this, lastLocalSeqIdDelivered,
									lastSeqIdConsumedUtil));
					// logger.info("");
					isThrottled = true;
	...
	public class SendMessageRequest implements DeliveryManagerRequest {
		/* This is a new class added by msgbus team(modified by Hrq) */
		...
		public SendMessageRequest(ActiveSubscriberState subscriber, Object ctx,
				Message message) {
			this.subscriber = subscriber;
		...
		public void performRequest() {
			...
			if (qc == null) {
				...
				subscriber.delivering.set(false); // ly modify
	...
	protected class AddConsumeSeqIdRequest implements DeliveryManagerRequest {
		...
		public void performRequest() {
			...
			if (cc != null) {
				cc.addConsumeSeqIdToCluster(topic, subscriberId, consumeSeqId,
						sm, callback, ctx);
			}
		}
	}
