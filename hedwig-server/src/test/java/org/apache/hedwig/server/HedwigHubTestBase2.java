 ...
 * 
 */
public abstract class HedwigHubTestBase2 extends TestCase {

	protected static Logger logger = LoggerFactory
			.getLogger(HedwigHubTestBase2.class);
	...
	public HedwigHubTestBase2() {
		this(2);
	}

	protected HedwigHubTestBase2(int numServers) {
