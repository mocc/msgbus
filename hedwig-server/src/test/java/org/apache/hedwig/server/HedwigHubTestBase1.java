 ...
 * 
 */
public abstract class HedwigHubTestBase1 extends TestCase {

	protected static Logger logger = LoggerFactory
			.getLogger(HedwigHubTestBase1.class);
	...
	public HedwigHubTestBase1() {
		this(1);
	}

	protected HedwigHubTestBase1(int numServers) {
	...
	// defined above.
	protected ServerConfiguration getServerConfiguration(int serverPort,
			int sslServerPort) {
	...
	protected void startHubServers() throws Exception {
		...
		for (int i = 0; i < numServers; i++) {
			System.out
					.println("enter serverConfig from hhtb.......................");
			ServerConfiguration conf = getServerConfiguration(serverAddresses
					.get(i).getPort(), serverAddresses.get(i).getSSLPort());
