...
public class TestConsumerCluster extends HedwigHubTestBase1 {
    ...
    protected class ConsumerClusterServerConfiguration extends HubServerConfiguration {
        ...
        public int getDefaultMessageWindowSize() {
            System.out.println("enter..............................getDefaultMW");
    ...
    public static void oneTimeSetUp() {
        ...
        System.out.println("......................" + System.getProperty("build.test.dir", "build"));// ly
    ...
    public void testMessageQueueClient_pub() throws Exception {
        ...
        // String path =
        // "D:/workspace/msgbus/hedwig-client/conf/hw_client.conf";
        URL conf = this.getClass().getResource("/hw_client.conf");
        final MsgBusClient msgBusClient = new MsgBusClient(conf);
    ...
    public void test() throws Exception {
        ...
        class QueueConsumer1 implements Runnable {
            ...
            public void run() {
                ...
                try {
                    t.recv(myArgs);
                    System.out.println(Thread.currentThread().getName() + ":quit.............recv");
                } catch (Exception e) {
