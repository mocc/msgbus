...
public class SyncConsumer {
	...
	public static Logger logger = LoggerFactory.getLogger(SyncConsumer.class);
	
	public SyncConsumer(String path) throws MalformedURLException, ConfigurationException {
	...
	public static void main(String[] args) throws Exception {
		...
		SyncConsumer c=new SyncConsumer("F:/Java Projects3/hedwig/hw_client.conf");
		c.recv(args);		
	}
